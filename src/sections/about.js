  ...
  return (
    ...
    >
      <div className="h-full flex flex-col md:flex-row justify-between md:justify-around items-center md:items-start md:pt-40">
        {/* CTA Section */}
        <div className="py-40 font-[900] font-primary lg:text-4xl text-2xl z-[2] flex flex-col px-10">
          <div className="pb-10">
            <h2> Hi,</h2>
            <h2> I am Razvan,</h2>
            <h2 className="text-colorLightBlue"> Frontend Developer</h2>
          </div>
          <button className="bg-colorAccentBlue p-2 rounded-xl">
            View Resume
          </button>
        </div>
      ...
      <svg viewBox="-300 -70 400 400" className="absolute top-0 z-[1]">
        <path
          className="animate-blob fill-colorAccentBlue dark:fill-colorLightBlue"
